...
const sourceColors: Record<string, string> = { WEIBO: '#e72b31', ZHIHU: '#1772f6', BAIDU: '#3b5bdb', DOUYIN: '#17191c', TOUTIAO: '#f04438', BILIBILI: '#00aeec', JUEJIN: '#1e80ff', OTHER: '#7b8186' }
function trendText() {
