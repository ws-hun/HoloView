...
const items = computed(() => activeSource.value === 'ALL' ? hotStore.latestHotItems : hotStore.bySource(activeSource.value))
...
<template>
  <div class="page-shell">
    ...
    <div class="board-toolbar">
      <PlatformTabs :platforms="hotStore.platforms" :active="activeSource" @select="activeSource = $event" />
